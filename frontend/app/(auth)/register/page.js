              ...
              <div className="flex flex-col items-center gap-2 w-full pt-1">
                <GoogleLogin
                  ...
                  onError={() => {
                    ...
                    setErrorMessage("Google Sign-Up: Official client ID not found on Google Cloud. You can use the 1-Click Google Test Sign-Up below or configure NEXT_PUBLIC_GOOGLE_CLIENT_ID.");
                  }}
                  theme="outline"
                  size="large"
                  width="100%"
                ...
                >
                  ...
                  <span>⚡ 1-Click Fast Google Sign-Up (Test / Sandbox)</span>
                </button>
              </div>
            </div>
          </div>
