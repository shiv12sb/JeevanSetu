...
function LoginForm() {
  ...
  const triggerGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        try {
          ...
          console.warn("Backend /auth/google sync notice:", syncErr.message);
        }
    ...
    onError: (err) => {
      ...
      setErrorMessage("Google Sign-In was cancelled or popup was closed.");
    },
  });

  const handleFastGoogleSignIn = () => {
    const googleUser = {
            ...
            <div className="pt-2">
              ...
              <div className="flex flex-col items-center gap-2.5 w-full pt-1">
                ...
                >
                  ...
                  <span>
                    {language === "mr"
                      ? "गुगलने लॉगिन करा (Sign in with Google)"
                      : language === "hi"
                ...
                <button
                  type="button"
                  onClick={handleFastGoogleSignIn}
                  disabled={isLoading}
                ...
                >
                  <span>⚡ 1-Click Fast Google Sign-In (Sandbox Mode)</span>
                </button>
              </div>
            </div>
