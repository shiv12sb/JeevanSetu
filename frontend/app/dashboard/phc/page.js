...
export default function PhcDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="p-6 bg-linear-to-r from-teal-800 to-slate-900 rounded-2xl text-white shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/inventory">
            <Button size="sm" className="bg-teal-500 hover:bg-teal-600 text-white font-bold gap-1.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/inventory" className="text-xs font-bold text-teal-700 dark:text-teal-400 hover:underline flex items-center gap-1">
              ...
              <TableBody>
                {criticalMeds.map((med) => (
                  <TableRow key={med.id}>
                    ...
                    <TableCell>
                      <span className="text-xs text-slate-600 dark:text-slate-400 font-semibold">{med.minimumThreshold} units</span>
                    </TableCell>
                    <TableCell className="text-right">
                      <Badge variant={med.status === "critical" ? "danger" : "warning"} size="sm">
